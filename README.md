# Boas vindas ao repositório do projeto MYSQL Vocabulary Booster!
...
Neste projeto eu explorei todos os conceitos vistos até o momento sobre **SQL**.
...
```bash
git clone git@github.com:apaulinhacarlos/trybe-back-mysql-vocabulary-booster.git
```

Acesse o diretório do projeto com o comando `cd`:

```bash
cd trybe-back-mysql-vocabulary-booster
```
